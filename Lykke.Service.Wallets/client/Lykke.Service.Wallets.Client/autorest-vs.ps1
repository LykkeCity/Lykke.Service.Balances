...
autorest -Input http://localhost:5000/swagger/v1/swagger.json -CodeGenerator CSharp -OutputDirectory ./client/Lykke.Service.Wallets.Client/AutorestClient -Namespace Lykke.Service.Wallets.Client.AutorestClient